...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<form [formGroup]=\"applicationForm\" class=\"form\" (ngSubmit)=\"submitApplication()\">\n    <h3 class=\"p-5 text-left title\">ACME Offer - New Application</h3>\n    <hr>\n    <div class=\"form-group row\">\n      <label for=\"country\" class=\"col-sm-2 col-form-label\">Country of Residence <span class=\"required\">*</span></label>\n\n      <div class=\"col-sm-3\">\n        <select class=\"form-control\" id=\"country\" [(ngModel)]=\"SelCountry\" (change)=\"loadStateDDL();\">\n            <option value=\"\">Please select</option>  \n                  <option *ngFor=\"let country of countries | async\" value={{country.CountryName}}>  \n                      {{Country.CountryName}}  \n                  </option>  \n          </select>\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"state\" class=\"col-sm-2 col-form-label\">State <span class=\"required\">*</span></label>     \n      <div class=\"col-sm-3\">\n          <select class=\"form-control\" id=\"state\">\n              <option value=\"\">--Select--</option>  \n                  <option *ngFor=\"let state of states | async\" value={{state.ID}}>  \n                      {{state.State}}  \n                  </option>  \n            </select>\n      </div>\n    </div> \n    <div class=\"form-group row\">\n        <label for=\"postcode\" class=\"col-sm-2 col-form-label\">Postcode <span class=\"required\">*</span></label>\n        \n        <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" id=\"postcode\">\n        </div>\n      </div> \n      <div class=\"form-group row\">\n          <label for=\"fullName\" class=\"col-sm-2 col-form-label\">Full Name <span class=\"required\">*</span></label>\n        \n          <div class=\"col-sm-3\">\n            <input type=\"text\" class=\"form-control\" id=\"fullName\">\n          </div>\n        </div>   \n        <br/>\n    <div class=\"form-group row\">\n      <div class=\"col-sm-10\">\n        <button type=\"submit\" class=\"btn btn-primary\">Submit Application</button>\n      </div>\n    </div>\n  </form>\n  ");
...
let HomeComponent = class HomeComponent {
    constructor(formbulider, commonService) {
...
let CommonService = class CommonService {
    constructor(http) {
        this.http = http;
        this.API_URL = "http://localhost:58304/api";
    }
    getCountries() {
        return this.http.get(this.API_URL + '/Country');
    }
    getStates() {
        return this.http.get(this.API_URL + '/State');
    }
};
...
module.exports = __webpack_require__(/*! C:\Projects\Reach\ACMEUI\src\main.ts */"./src/main.ts");
